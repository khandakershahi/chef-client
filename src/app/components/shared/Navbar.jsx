    ...
    <header className="bg-base-200 shadow-sm sticky top-0 z-50">
      <Container>
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="uppercase text-sm font-medium tracking-widest text-base-content hover:text-primary">
                    {link.label}
                  </Link>
                </li>
              ))}
              <li>
                <button className="btn btn-sm bg-base-content text-base-100 font-bold uppercase tracking-widest mt-2 hover:opacity-90">
                  Login
                </button>
              </li>
            </ul>
          ...
          <ul className="menu menu-horizontal px-1">
            {navLinks.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="text-sm font-medium uppercase tracking-widest text-base-content hover:text-primary transition-colors"
                >
                  {link.label}
                </Link>
              </li>
        ...
        <div className="navbar-end gap-2">
          ...
          <button className="btn btn-sm bg-base-content text-base-100 hidden sm:inline-flex uppercase tracking-widest font-bold hover:opacity-90">
            Login
          </button>
        </div>
        </div>
