    ...
    <header className="bg-base-200 shadow-sm sticky top-0 z-50">
      <Container>
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              <li>
                <button className="btn btn-primary btn-sm font-bold uppercase tracking-widest mt-2">
                  Login
                </button>
              </li>
            </ul>
        ...
        <div className="navbar-end gap-2">
          ...
          <button className="btn btn-sm btn-primary hidden sm:inline-flex uppercase tracking-widest font-bold">
            Login
          </button>
        </div>
        </div>
