        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <div className="flex items-center justify-between py-2">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-gray-800 dark:text-white text-sm font-medium">Remember me</span>
            </label>
          ...
          <div className="flex justify-center pb-4 pt-2">
            <Link href="/" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 text-sm font-medium hover:text-primary dark:hover:text-secondary transition-colors">
              <span>←</span>
