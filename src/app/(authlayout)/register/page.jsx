        ...
        <div className="w-full max-w-[480px] bg-white/85 dark:bg-base-content/85 backdrop-blur-md rounded-xl shadow-2xl overflow-hidden border border-white/20 dark:border-white/10">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-4">
            ...
            <div className="flex flex-col gap-2 mb-6">
              <h1 className="text-base-content dark:text-white text-3xl font-black leading-tight">Create Account</h1>
              <p className="text-base-content/60 dark:text-gray-400 text-base">Join our culinary community, Chef.</p>
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex w-full items-stretch">
                ...
                <button
                  ...
                  className="px-4 bg-white dark:bg-base-200 border border-base-300 dark:border-base-600 border-l-0 rounded-r-lg text-base-content/60 hover:text-base-content transition-colors flex items-center justify-center"
                >
                  {showPassword ? '👁️' : '👁️‍🗨️'}
                </button>
              </div>
            ...
            <div className="py-2">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-base-content dark:text-gray-300 text-sm">
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full h-14 rounded-lg bg-secondary hover:bg-secondary/90 text-base-content font-black uppercase tracking-widest transition-colors shadow-md"
              >
                Create Account
              </button>
            </div>
            ...
            <div className="flex justify-center text-center gap-2 pb-4 pt-2">
              <span className="text-base-content/60 dark:text-gray-400 text-sm">Already have an account?</span>
